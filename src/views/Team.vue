  ...
  <v-container fluid>
      ...
      <v-card class="text-xs-center dialog-delete">
        ...
        <v-card-actions>
          ...
          <v-btn
            color="blue darken-1"
            flat
            @click="deleteDialog = false;deleteTeamId = 0;"
          >
            No
          </v-btn>
        </v-card-actions>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-center">
          <v-icon @click="updateTeamDialog(props.item)">
            mdi-square-edit-outline
          </v-icon>
          <v-icon @click.stop="deleteTeamDialog(props.item.id)">
