  ...
  <v-container fluid>
      ...
      <v-card class="text-xs-center dialog-delete">
        ...
        <v-card-actions>
          ...
          <v-btn
            color="blue darken-1"
            flat
            @click="deleteDialog = false;deletePlayerId = 0;"
          >
            No
          </v-btn>
        </v-card-actions>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-center">
          <v-icon @click.stop="updatePlayerDialog(props.item)">
            mdi-square-edit-outline
          </v-icon>
          <v-icon @click.stop="deletePlayerDialog(props.item.id)">
